...
class CircuitFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'api_modified_at' => fake()->dateTimeBetween('-30 days', 'now'),
            'api_status' => 'ACTIV',
            'api_data_json' => null,
            'taken_by' => fake()->randomElement(['ASPLUNDH', 'PENNLINE', 'LEWISTREE']).'\\'.fake()->userName(),
            'ws_version' => fake()->numberBetween(1, 100),
            'ws_sync_version' => fake()->numberBetween(1, 100),
            'last_synced_at' => now(),
